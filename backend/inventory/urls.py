...
urlpatterns = [
    ...
    path("balances/import-excel/", balance_import_excel, name="balance-import-excel"),
    ...
    path("movements/export-excel/", movement_export_excel, name="movement-export-excel"),
    ...
    path("purchasing/requests/", internal_requests, name="internal-requests"),
    path("purchasing/alarms/", purchasing_alarms, name="purchasing-alarms"),
    path("purchasing/auto-purchase-config/", auto_purchase_config, name="auto-purchase-config"),
